...
describe('UsersService', () => {
  ...
  it('should create a user successfully', () => {
    const user = { name: 'samir maity', email: 'samir@gmail.com' };
  ...
  it('should find all users', () => {
    service.create({ name: 'samir maity', email: 'samir@gmail.com' });
    const users = service.findAll();
    expect(users).toHaveLength(1);
  });

  it('should find a user by ID', () => {
    const user = service.create({ name: 'samir maity', email: 'samir@gmail.com' });
